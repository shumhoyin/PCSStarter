...
//======================================================================
// ExitGateEmulator
public class ExitGateEmulator extends ExitGateHandler {
    private Stage myStage;
    private ExitGateEmulatorController exitgateEmulatorController;
    ...
    //------------------------------------------------------------
    // ExitGateEmulator
    public ExitGateEmulator(String id, PCSStarter pcsStarter) {
        super(id, pcsStarter);
    ...
    public void start() throws Exception {
        ...
        String fxmlName = "ExitGateEmulator.fxml";
        loader.setLocation(ExitGateEmulator.class.getResource(fxmlName));
        root = loader.load();
       exitgateEmulatorController = (ExitGateEmulatorController) loader.getController();
       exitgateEmulatorController.initialize(id, pcsStarter, log, this);
        ...
        myStage.setTitle("Exit Gate Emulator");
    ...
    private final void logFine(String logMsg) {
        exitgateEmulatorController.appendTextArea("[FINE]: " + logMsg);
        log.fine(id + ": " + logMsg);
    } // logFine
    ...
    private final void logInfo(String logMsg) {
        exitgateEmulatorController.appendTextArea("[INFO]: " + logMsg);
        log.info(id + ": " + logMsg);
    } // logInfo
    ...
    private final void logWarning(String logMsg) {
        exitgateEmulatorController.appendTextArea("[WARNING]: " + logMsg);
    ...
    private final void logSevere(String logMsg) {
        exitgateEmulatorController.appendTextArea("[SEVERE]: " + logMsg);

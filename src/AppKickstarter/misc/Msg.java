...
public class Msg {
	...
	/** Toggling Gate PCS.SensorHandler.Emulator.Emulator AutoOpen */	GateEmulatorAutoOpenToggle,
	/** Toggling Gate PCS.SensorHandler.Emulator.Emulator AutoClose */	GateEmulatorAutoCloseToggle,
	/** Toggling Gate PCS.SensorHandler.Emulator.Emulator AutoPoll */	GateEmulatorAutoPollToggle,

    /**Get a ticket */ TicketRequest,
    /**Return the ticket information*/ EntranceInfoReply,
    /**ticket collected signal*/ TicketCollected,
